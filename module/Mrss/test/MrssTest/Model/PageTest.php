...
class PageTest extends PHPUnit_Framework_TestCase
{
    ...
    {
        $this->model = new \Mrss\Model\Page();
    }
    ...
    {
        $this->assertInstanceOf('Mrss\Model\Page', $this->model);
    }
    ...
    /*public function testFindOneByRouteAndStudy()
    {
        $queryMock = $this->getMock(
            'Doctrine\ORM\Query',
            array('getOneOrNullResult')
        );
        $qbMock = $this->getMock(
        ...
        $repoMock = $this->getMock(
            'Doctrine\ORM\EntityRepository',
            array('createQueryBuilder', 'getUnitOfWork'),
            array(),
            '',
            false
        );
        ...
        $result = $this->model->findOneByRouteAndStudy('imprint', 1);
    ...
    public function testSave()
    {
        ...
        $this->model->save(new \Mrss\Entity\Page);
    }
    ...
    public function testDelete()
    {
        ...
        $pageMock = $this->getMock('Mrss\Entity\Page');
