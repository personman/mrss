...
class Version20140904001830 extends AbstractMigration
{
    public function up(Schema $schema)
    {
        ...
        $this->addSql("ALTER TABLE observations ADD ss_salaries DOUBLE PRECISION DEFAULT NULL, ADD ss_0_cost DOUBLE PRECISION DEFAULT NULL, ADD ss_contract DOUBLE PRECISION DEFAULT NULL, ADD ss_admissions_percent_salaries DOUBLE PRECISION DEFAULT NULL, ADD ss_recruitment_percent_salaries DOUBLE PRECISION DEFAULT NULL, ADD ss_advising_percent_salaries DOUBLE PRECISION DEFAULT NULL, ADD ss_counseling_percent_salaries DOUBLE PRECISION DEFAULT NULL, ADD ss_career_percent_salaries DOUBLE PRECISION DEFAULT NULL, ADD ss_financial_aid_percent_salaries DOUBLE PRECISION DEFAULT NULL, ADD ss_registrar_percent_salaries DOUBLE PRECISION DEFAULT NULL, ADD ss_tutorings_percent_salaries DOUBLE PRECISION DEFAULT NULL, ADD ss_testing_percent_salaries DOUBLE PRECISION DEFAULT NULL, ADD ss_cocurricular_percent_salaries DOUBLE PRECISION DEFAULT NULL, ADD ss_disabserv_percent_salaries DOUBLE PRECISION DEFAULT NULL, ADD ss_vetserv_percent_salaries DOUBLE PRECISION DEFAULT NULL");
    }
